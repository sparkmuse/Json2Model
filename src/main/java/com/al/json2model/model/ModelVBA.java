 ...
 *
 */
public class ModelVBA extends ModelAbstract {
	 ...
	 * @see ModelAbstract
	 */
	public ModelVBA(String name, String json, Language language, String destFolder) {
	...
	protected DataType getArrayDataType(Map.Entry<String, JsonElement> entry) {
		...
		return new DataType(entry.getKey(), type, false);
	}

	@Override
	protected void prepareFiles() {

		final String fileExtension = ".cls";
